...
<body class="h-full text-base-content">
    <div class="min-h-screen bg-neutral-50 flex items-center justify-center">
        ...
        <div id="email-verification-container" class="w-full max-w-md">
            <!-- Logo and Header -->
            ...
            <div id="verification-success"
                class="bg-white rounded-lg border border-neutral-200 p-8 shadow-sm text-center">
                <!-- Success Icon -->
                <div class="w-20 h-20 bg-neutral-100 rounded-full flex items-center justify-center mx-auto mb-6">
                    <i class="fa-solid fa-check text-neutral-600 text-3xl"></i>
                </div>

                <h2 class="text-2xl text-neutral-900 mb-4">{{ $message }}</h2>
                <p class="text-neutral-600 mb-8">Akun Anda telah berhasil diverifikasi. Silakan login untuk mengakses
                    sistem penjadwalan ruangan kelas.</p>

                <!-- Login Button -->
                <button
                    class="w-full bg-neutral-900 text-white py-3 rounded-lg hover:bg-neutral-800 transition-colors flex items-center justify-center mb-4">
                    <i class="fa-solid fa-sign-in-alt mr-2"></i>
                    Login Sekarang
                </button>

                <button
                    class="w-full bg-white text-neutral-900 py-3 rounded-lg border border-neutral-300 hover:bg-neutral-50 transition-colors flex items-center justify-center">
            ...
            <!-- Footer -->
            <footer id="verification-footer" class="mt-8 text-center text-sm text-neutral-500">
