...
Route::middleware('authAdmin.api')->group(function () {
    ...
    Route::middleware('api')->post('/admin_akses_pengguna_mahasiswa/add', [mahassiwaController::class, 'createMahasiswa']);
    // edit data dosen
    ...
    // tambah data dosen
    Route::middleware('api')->post('/admin_akses_pengguna_dosen/add', [dosenController::class, 'createDosen']);
});
